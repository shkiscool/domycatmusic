...
<body class="">
      ...
      <form class="navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs" role="search">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" id="txtSearch" class="form-control input-sm no-border rounded" placeholder="搜索 歌曲 歌手。。。">
          </div>
        </div>
      </form>
                  ...
                  <section class="vbox animated fadeInUp">
                    <section class="scrollable hover">
                      <div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
                        <a href="musicLib.jsp" class="list-group-item">
                          All
                        </a>
                        <a href="musicLib.jsp" class="list-group-item active">
                          acoustic
                        </a>
                        <a href="musicLib.jsp" class="list-group-item">
                          ambient
  ...
  $(function(){
	  ...
	  $("#btnSearch").click(function(){
		 ...
		 $.ajax({
			 url:"${pageContext.request.contextPath}/MusicController?op=search";
			 data: keyword,
